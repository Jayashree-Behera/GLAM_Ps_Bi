...
# GLAM directory
dir = "/global/project/projectdirs/desi/mocks/GLAM/JFE_files/z_Raw_boxes/PMILL/z0.0/"
...
for filename in readdir(dir)
    ...
    if filename[1:9] == "CatshortV"
        try 
            outfile = string("/global/u1/s/shreeb/GLAM_Bi/z0.0/BAO/Bk_",chop(filename,tail=2),"DAT")
...
# GLAM directory
dir = "/global/project/projectdirs/desi/mocks/GLAM/JFE_files/z_Raw_boxes/PMILL_noBAO/z0.0/"
...
for filename in readdir(dir)
    ...
    if filename[1:9] == "CatshortV"
        try 
            outfile = string("/global/u1/s/shreeb/GLAM_Bi/z0.0/noBAO/Bk_",chop(filename,tail=2),"DAT")
            if isfile(outfile) continue end
            println(string(dir,filename))
            # Extract x, y, z
            x, y, z = read_glam(string(dir,filename))
